  ...
  module ClassMethods
    ...
    def it_should_not_have_a_label
      it "should not have a label" do
        output_buffer.should_not have_tag("form label")
      end
    end
    ...
    def it_should_have_a_nested_fieldset_with_class(klass)
      it "should have a nested_fieldset with class #{klass}" do
        output_buffer.should have_tag("form fieldset.#{klass}")
      end
    end
    ...
    def it_should_have_label_with_text(string_or_regex)
      it "should have a label with text '#{string_or_regex}'" do
        output_buffer.should have_tag("form label", string_or_regex)
      end
    end

    def it_should_have_label_for(element_id)
      it "should have a label for ##{element_id}" do
        output_buffer.should have_tag("form label[@for='#{element_id}']")
      end
    end
    ...
    def it_should_use_default_text_field_size_when_not_nil(as)
      it 'should use default_text_field_size when not nil' do
        with_config :default_text_field_size, 30 do
          ...
          output_buffer.should have_tag("form input[@size='#{Formtastic::FormBuilder.default_text_field_size}']")
        end
      end
    end
    ...
    def it_should_not_use_default_text_field_size_when_nil(as)
      it 'should not use default_text_field_size when nil' do
        with_config :default_text_field_size, nil do
          ...
          output_buffer.should have_tag("form input")
          output_buffer.should_not have_tag("form input[@size]")
        end
      end
    end
    ...
    def it_should_apply_custom_input_attributes_when_input_html_provided(as)
      it 'it should apply custom input attributes when input_html provided' do
        ...
        output_buffer.should have_tag("form input.myclass")
      end
    end
    ...
    def it_should_apply_custom_for_to_label_when_input_html_id_provided(as)
      it 'it should apply custom for to label when input_html :id provided' do
        ...
        output_buffer.should have_tag('form label[@for="myid"]')
      end
    end
    ...
    def it_should_have_maxlength_matching_column_limit
      it 'should have a maxlength matching column limit' do
        ...
        output_buffer.should have_tag("form input[@maxlength='50']")
      end
    end
    ...
    def it_should_use_column_size_for_columns_shorter_than_default_text_field_size(as)
      it 'should use the column size for columns shorter than default_text_field_size' do
        ...
        output_buffer.should have_tag("form input[@size='#{column_limit_shorted_than_default}']")
      end
    end
    ...
    def it_should_apply_error_logic_for_input_type(type, inline_or_block = :inline)
      describe 'when there are errors on the object for this method' do
        ...
        it 'should render a paragraph for the errors' do
          FormtasticFoundation::FormBuilder.inline_errors = :sentence
          concat(semantic_form_for(@new_post) do |builder|
            concat(builder.input(:title, :as => type))
          end)
        ...
        it 'should not display an error list' do
          FormtasticFoundation::FormBuilder.inline_errors = :list
          concat(semantic_form_for(@new_post) do |builder|
            concat(builder.input(:title, :as => type))
          end)
    ...
    def it_should_use_the_collection_when_provided(as, countable)
      ...
      describe 'when the :collection option is provided' do
        ...
        it 'should use the provided collection' do
          ...
          output_buffer.should have_tag("form #{countable}", :count => @authors.size + (as == :select ? 1 : 0))
        end
        ...
        describe 'and the :collection is an array of strings' do
          ...
          it "should use the string as the label text and value for each #{countable}" do
            ...
            @categories.each do |value|
              output_buffer.should have_tag("form", /#{value}/)
              output_buffer.should have_tag("form #{countable}[@value='#{value}']")
            end
          end
          ...
          if as == :radio
            it 'should generate a sanitized label for attribute' do
              ...
              output_buffer.should have_tag("form label[@for='post_author_category_name_general']")
              output_buffer.should have_tag("form label[@for='post_author_category_name_design']")
              output_buffer.should have_tag("form label[@for='post_author_category_name_development']")
              output_buffer.should have_tag("form label[@for='post_author_category_name_quasi-serious_inventions']")
            end
          end
        end
        ...
        describe 'and the :collection is an array of arrays' do
          ...
          it "should use the first value as the label text and the last value as the value attribute for #{countable}" do
            ...
            @categories.each do |text, value|
              ...
              output_buffer.should have_tag("form #{label}", /#{text}/i)
              output_buffer.should have_tag("form #{countable}[@value='#{value.to_s}']")
              output_buffer.should have_tag("form #{countable}#post_category_name_#{value.to_s}") if as == :radio
            end
          end
        end
        ...
        if as == :radio
          describe 'and the :collection is an array of arrays with boolean values' do
            ...
            it "should use the first value as the label text and the last value as the value attribute for #{countable}" do
              ...
              output_buffer.should have_tag("form #{countable}#post_category_name_true")
              output_buffer.should have_tag("form #{countable}#post_category_name_false")
            end
          end
        end
        ...
        describe 'and the :collection is an array of symbols' do
          ...
          it "should use the symbol as the label text and value for each #{countable}" do
            ...
            @categories.each do |value|
              label = as == :select ? :option : :label
              output_buffer.should have_tag("form #{label}", /#{value}/i)
              output_buffer.should have_tag("form #{countable}[@value='#{value.to_s}']")
            end
          end
        end
        ...
        describe 'when the :member_label option is provided' do
          ...
          describe 'as a symbol' do
            ...
            it 'should have options with text content from the specified method' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form", /#{author.login}/)
              end
            end
          end
          ...
          describe 'as a proc' do
            ...
            it 'should have options with the proc applied to each' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form", /#{author.login.reverse}/)
              end
            end
          end
          ...
          Formtastic::FormBuilder.collection_label_methods.each do |label_method|
            ...
            describe "when the collection objects respond to #{label_method}" do
              ...
              it "should render the options with #{label_method} as the label" do
                ::Author.all.each do |author|
                  output_buffer.should have_tag("form", /The Label Text/)
                end
              end
            end
        ...
        describe 'when the :member_value option is provided' do
          ...
          describe 'as a symbol' do
            ...
            it 'should have options with values from specified method' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form #{countable}[@value='#{author.login}']")
              end
            end
          end
          ...
          describe 'as a proc' do
            ...
            it 'should have options with the proc applied to each value' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form #{countable}[@value='#{author.login.reverse}']")
              end
            end
          end
